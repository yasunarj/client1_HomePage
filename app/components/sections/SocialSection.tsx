      ...
      <Container>
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 z-10">
          ...
          <div className="w-full max-w-lg mx-auto">
            <div className="flex flex-col bg-white rounded-xl overflow-hidden shadow-lg min-h-[875px]">
              ...
              <div className="p-4">
                <InstagramEmbed
                  url={
                    "https://www.instagram.com/p/DIG1tLUzoMv/?utm_source=ig_embed&amp;utm_campaign=loading"
                  }
                />
              </div>
            </div>
          ...
          {/* 個人用Instagram */}
          <div className="w-full max-w-lg mx-auto h-full min-h-[500px] rounded-xl overflow-hidden">
            <div className="flex flex-col bg-white shadow-lg max-h-[550px] md:max-h-[875px]">
              <div className="bg-gradient-to-r from-orange-500 to-red-600">
                <h3 className="text-xl font-bold text-white text-center">
                  熱波師のSNS情報
                </h3>
