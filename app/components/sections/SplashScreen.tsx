...
export default function SplashScreen({ isFading }: SplashScreenProps) {
  return (
    <div className={`fixed inset-0 flex items-center justify-center bg-gradient-to-b  from-orange-500 to-red-700 transition-opacity duration-1000 ${isFading ? 'opacity-0' : 'opacity-100'}`}>
