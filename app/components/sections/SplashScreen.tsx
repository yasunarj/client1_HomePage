...
export default function SplashScreen({ isFading }: SplashScreenProps) {
  return (
    <div className={`min-h-[100dvh] fixed inset-0 flex items-center justify-center bg-gradient-to-br from-orange-500 to-red-700 overflow-hidden transition-opacity duration-1000 ${isFading ? 'opacity-0' : 'opacity-100'}`}>
