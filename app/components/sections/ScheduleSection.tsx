...
import ScheduleSlider from "./SchedulesSlider";
...
export default async function ScheduleSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_20%,rgba(249,115,22,0.28),transparent_38%)]" />
      ...
      <div className="relative z-10 w-full">
        ...
        <Container>
          ...
          <ScheduleSlider scheduleList={scheduleList}/>
        </Container>
      </div>
    </section>
  );
