...
export default function Header() {
  ...
  return (
  <header className="fixed top-0 left-0 right-0 bg-white/80 backdrop-blur-sm z-20 shadow-sm select-none">
        ...
        <nav className="hidden md:flex space-x-5 lg-space-x-8">
          {headerNavList.map((list) => {
            return (
              <button
                key={list.id}
                className="group relative text-sm lg:text-base hover:text-orange-500 transition-color"
